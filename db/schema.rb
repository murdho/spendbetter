...
ActiveRecord::Schema[8.0].define(version: 2024_07_06_132431) do
  ...
  create_table "entries_stickers", id: false, force: :cascade do |t|
    t.integer "entry_id", null: false
    t.integer "sticker_id", null: false
    t.index ["entry_id"], name: "index_entries_stickers_on_entry_id"
    t.index ["sticker_id"], name: "index_entries_stickers_on_sticker_id"
  end
